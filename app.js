function makeTicket()
{
	...
	let passengerSex = document.getElementById("passengerSex").value;
...
<span style="font-weight:normal;font-family:roboto,helvetica neue,helvetica,arial,sans-serif">Hey ${passengerName},
</span>
</div>
...
<h4 style="margin-top:2px;font-size:14px;font-weight:bold;font-stretch:normal;font-style:normal;line-height:1.73;letter-spacing:normal;color:#47475d;font-family:roboto,helvetica neue,helvetica,arial,sans-serif">${passengerName}<div style="font-size:12px;font-weight:normal;font-stretch:normal;font-style:normal;line-height:1.0;letter-spacing:normal;color:#747f8d;padding-left:29px;font-family:roboto,helvetica neue,helvetica,arial,sans-serif">
`+passengerAge+`Yrs, ${passengerSex}</div>
</h4>
...
{ 
	...
	let color2 = colors[Math.floor(Math.random() * colors.length)];
        document.body.style.background = `background: linear-gradient(to right, ${color}, ${color2});`;
             }
